...
require([
  "swiper-bundle.min",			//スライダーJS
	...
	//.mySwiperTypeBasic　スライダー カスタマイズ動画事例
	const mySwiperTypeBasic01 = new Swiper('.sliderBox--typeBasic.--typeCustomizationExample .swiper', {
		slidesPerView: 1,
		spaceBetween: 0,
		grabCursor: true,
		pagination: {
			el: '.sliderBox--typeBasic.--typeCustomizationExample .swiper-pagination',
			clickable: true,
		},
	    	navigation: {
	      		nextEl: '.sliderBox--typeBasic.--typeCustomizationExample .swiper-button-next',
	      		prevEl: '.sliderBox--typeBasic.--typeCustomizationExample .swiper-button-prev',
	    	},
	    	breakpoints: {
	      		600: {
	        		slidesPerView: 1,
	...
	const mySwiperTypeBasic02 = new Swiper('.sliderBox--typeBasic.--typeBlog .swiper', {
		slidesPerView: 1,
		spaceBetween: 0,
		grabCursor: true,
		pagination: {
			el: '.sliderBox--typeBasic.--typeBlog .swiper-pagination',
			clickable: true,
		},
	    	navigation: {
	      		nextEl: '.sliderBox--typeBasic.--typeBlog .swiper-button-next',
	      		prevEl: '.sliderBox--typeBasic.--typeBlog .swiper-button-prev',
	    	},
	    	breakpoints: {
	      		600: {
	        		slidesPerView: 1,
	...
	//.mySwiperTypeBasic　スライダー メカニックブログ
	const mySwiperTypeBasic03 = new Swiper('.sliderBox--typeBasic.--typeMechanic .swiper', {
		slidesPerView: 1,
		spaceBetween: 0,
		grabCursor: true,
		pagination: {
			el: '.sliderBox--typeBasic.--typeMechanic .swiper-pagination',
			clickable: true,
		},
	    	navigation: {
	      		nextEl: '.sliderBox--typeBasic.--typeMechanic .swiper-button-next',
	      		prevEl: '.sliderBox--typeBasic.--typeMechanic .swiper-button-prev',
	    	},
	    	breakpoints: {
	      		600: {
	        		slidesPerView: 1,
